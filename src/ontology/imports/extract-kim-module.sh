...
java -jar robot.jar merge --input skos_import.owl --input schularten.ttl extract --method TOP --term 'http://www.w3.org/2004/02/skos/core#Concept' --term 'http://www.w3.org/2004/02/skos/core#closeMatch' --term 'http://www.w3.org/2004/02/skos/core#narrowMatch' --output kim-extracted.ttl
...
java -jar robot.jar remove --term "http://www.w3.org/2004/02/skos/core#Concept" --term "http://www.w3.org/2004/02/skos/core#topConceptOf" --input kim-extracted.ttl --output kim-extracted.ttl
